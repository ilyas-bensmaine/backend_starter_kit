...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'selectedUsage' => "destination de l'immeuble",
        'selectedCommandement' => 'commandement',
        'organe' => 'utilisateur',
        'adresse' => 'adresse',
        'selectedWilaya' => 'wilaya',
        'selectedCommune' => 'commune',
        'superficieDeveloppe' => 'superficie developpe',
        'superficieTotale' => 'superficie totale',
        'superficieBatie' => 'superficie batie',
        'superficieNue' => 'superficie nue',
        'constructionDate' => 'date de construction',
        'selectedConstructionType' => 'type de construction',
    ],
