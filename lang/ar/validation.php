...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'selectedUsage' => 'نوع الملك العقار',
        'selectedCommandement' => 'القيادة',
        'organe' => 'المستعمل',
        'adresse' => 'العنوان',
        'selectedWilaya' => 'الولاية',
        'selectedCommune' => 'البلدية',
        'superficieDeveloppe' => 'المساحة المطورة',
        'superficieTotale' => 'المساحة الكلية',
        'superficieBatie' => 'المساحة المبنية',
        'superficieNue' => 'المساحة غير مبنية',
        'constructionDate' => 'تاريخ البناء',
        'selectedConstructionType' => 'نوع البناء',
    ],
];
